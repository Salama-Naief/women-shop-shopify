  ...
  return (
    <div className='p-4'>
        <div className="bg-gray-200 text-gray-900 flex flex-col justify-center px-4">
            ...
            <div className="my-2 flex items-center"><MdPersonOutline className='text-2xl text-primary mx-2'/><span className='font-serif'>{commentSpit[0]}</span></div>
            <div className="my-2 flex items-center"><MdOutlineMail className='text-2xl text-primary mx-2'/><span className='font-serif'>{commentSpit[1]}</span></div>   
        </div>
